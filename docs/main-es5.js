...
var RegistrationComponent = /** @class */ (function () {
    function RegistrationComponent(_fb, authService, router) {
        this._fb = _fb;
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.login = function (userName, password) {
        var _this = this;
        return this.httpClient.post("http://localhost:4200/auth/login", { userName: userName, password: password })
...
var token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9.eyJmb28iOiJiYXIiLCJpYXQiOjE0MzQ0Nzk4ODN9.HQyx15jWm1upqsrKSf89X_iP0sg7N46a9pqBVGPMYdiqZeuU_ZZOdU-zizHJoIHMIJxtEWzpSMaVubJW0AJsTqjqQf6GoJ4cmFAfmfUFXmMC4Xv5oc4UqvGizpoLjfZedd834PcwbS-WskZcL4pVNmBIGRtDXkoU1j2X1P5M_sNJ9lYZ5vITyqe4MYJovQzNdQziUNhcMI5wkXncV7XzGInBeQsPquASWVG4gb3Y--k1P3xWA4Df3rKeEQBbInDKXczvDpfIlTojx4Ch8OM8vXWWNxW-mIQrV31wRrS9XtNoig7irx8N0MzokiYKrQ8WP_ezPicHvVPIHhz-InOw";
var users = [];
var FakeBackInterceptor = /** @class */ (function () {
    function FakeBackInterceptor() {
    }
    FakeBackInterceptor.prototype.intercept = function (req, next) {
        var url = req.url, method = req.method, headers = req.headers, body = req.body;
